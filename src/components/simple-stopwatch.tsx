    ...
    <div className="flex flex-col h-full items-center text-center pt-4">
      <Card className="w-full">
        <CardContent className="p-4 flex flex-col items-center gap-4">
          <div className="text-7xl font-mono font-bold tracking-tighter w-full">
            {time}
          </div>
      ...
      <Card className="w-full mt-4 relative">
        <CardHeader className="p-2 flex flex-row items-center justify-between relative">
              ...
              <div className="p-2">
                {laps.map((lapItem, index) => (
                  <div
                    key={index}
                    className={cn(
                      "flex justify-between items-center p-2 rounded-md text-sm font-mono",
                      lapItem.type === "best" &&
